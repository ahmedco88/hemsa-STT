...
Values come from the author's house design system (palettes.css), copied verbatim
with light + dark groups per palette and WCAG-measured as pairs - never re-tune a
value by eye. Ochre and forest are deliberately excluded from Hemsa: ochre's base
equals the shared WARN ink and forest's greens collide with OK.
...
THEMES = {
    "plum": {
        "PAPER": "#F1EEFA", "CARD": "#FFFFFF", "INK": "#1B1626", "MUTED": "#625A75",
        "LINE": "#E7E2F2", "MIST": "#D5CCEE", "ACCENT": "#5B47A8",
    ...
    "navy": {
        "PAPER": "#EAF1F8", "CARD": "#FFFFFF", "INK": "#0F1B2A", "MUTED": "#54657E",
        "LINE": "#E2E9F1", "MIST": "#C7D8E9", "ACCENT": "#17457C",
    ...
    "teal": {
        "PAPER": "#E6F2EE", "CARD": "#FFFFFF", "INK": "#0E1F1A", "MUTED": "#4E6961",
        "LINE": "#DDEBE6", "MIST": "#B8DED3", "ACCENT": "#0F6E56",
    ...
    "inkblue": {
        "PAPER": "#EDF1FB", "CARD": "#FFFFFF", "INK": "#14181F", "MUTED": "#656D78",
        "LINE": "#E4E9F4", "MIST": "#C9D7F5", "ACCENT": "#2F5FD0",
